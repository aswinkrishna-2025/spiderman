...
export default function Home(){return <>
  <section className="comic-panel relative min-h-[94vh] overflow-hidden border-x-0 border-t-0 px-5 pt-[72px]">
    <Image src="/hero-city.png" alt="Crimson futuristic city" fill priority className="object-cover object-center"/>
    <div className="absolute inset-0 bg-gradient-to-r from-[#02050a] via-[#02050a]/85 to-transparent"/><div className="absolute inset-0 bg-gradient-to-t from-ink via-transparent to-[#061327]/20"/><div className="web -right-24 top-16"/>
    <div className="relative mx-auto flex min-h-[calc(92vh-4rem)] max-w-7xl items-center"><motion.div initial={{opacity:0,x:-30}} animate={{opacity:1,x:0}} className="max-w-3xl py-20">
      ...
      <p className="mt-5 text-xl font-semibold sm:text-2xl">Swing into the ultimate quiz. Each winning participant gets a ₹200 movie ticket.</p>
